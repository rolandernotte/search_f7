...
function onDeviceReady() {
	...
	function geolocationSuccess(position){
		...
		var apiUrl = 'https://api.foursquare.com/v2/venues/search?ll=' + latitude + ',' + longitude +'&query=pizza&radius=5000&client_id=PK0Y1ACSYMNAIX4MROUYVQAF1X1LI0XOCJO03KDOAXEIJLYL&client_secret=CR32EQUBR2KESYGHFIVPPKSTDKIYKCQAVGAY3ODS2OB3B2M1&v=20201125';
	...
	$(document).on('page:init', '.page[data-name="details"]', function(e){
		...
		var apiUrl = 'https://api.foursquare.com/v2/venues/' + id +'?client_id=PK0Y1ACSYMNAIX4MROUYVQAF1X1LI0XOCJO03KDOAXEIJLYL&client_secret=CR32EQUBR2KESYGHFIVPPKSTDKIYKCQAVGAY3ODS2OB3B2M1&v=20191112';
